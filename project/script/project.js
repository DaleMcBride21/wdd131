...
function displayLaptopCard(products) {
    const cardContainer = document.getElementById('laptop');
...
function displayComputerPartsCard(products) {
    const cardContainer = document.getElementById('computerParts');
    cardContainer.innerHTML = '';
    products.forEach(product => {
        if (product.type === 'computerParts') {
            const card = createCard(product);
            cardContainer.appendChild(card);
        }
    });
...
function displayMobileCard(products) {
    const cardContainer = document.getElementById('mobile');
    cardContainer.innerHTML = '';
    products.forEach(product => {
...
displayLaptopCard(products)
displayComputerPartsCard(products)
displayMobileCard(products)
